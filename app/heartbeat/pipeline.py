...
STEP_MODULES: tuple[str, ...] = (
    ...
    "app.heartbeat.steps.24_slow_enrichment_queue.pipeline",
    "app.heartbeat.steps.25_context_enrichment.pipeline",
    "app.heartbeat.steps.26_strategy_signals.pipeline",
    "app.heartbeat.steps.27_analysis_gemini.pipeline",
    "app.heartbeat.steps.28_shadow_proposals.pipeline",
    "app.heartbeat.steps.29_risk_cfo.pipeline",
    "app.heartbeat.steps.30_execution_paper.pipeline",
    "app.heartbeat.steps.31_risk_live_cfo.pipeline",
    "app.heartbeat.steps.32_execution_live.pipeline",
    "app.heartbeat.steps.33_evaluation_post_trade.pipeline",
    "app.heartbeat.steps.34_notifications_slack.pipeline",
)
