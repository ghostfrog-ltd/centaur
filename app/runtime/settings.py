...
def load_runtime_config() -> RuntimeConfig:
    ...
    config = RuntimeConfig(
        ...
        live_execution_high_score_override_min_score=_parse_float(
            os.getenv("LIVE_EXECUTION_HIGH_SCORE_OVERRIDE_MIN_SCORE"),
            default=90.0,
        ),
...
def _validate_live_same_as_paper_config(config: RuntimeConfig) -> None:
    ...
    mirrored_fields = (
        ...
        ("execution_high_score_override_enabled", "paper_execution_high_score_override_enabled", "live_execution_high_score_override_enabled"),
        ("execution_high_score_override_min_score", "paper_execution_high_score_override_min_score", "live_execution_high_score_override_min_score"),
        ("execution_high_score_override_fitness_margin", "paper_execution_high_score_override_fitness_margin", "live_execution_high_score_override_fitness_margin"),
